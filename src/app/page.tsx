  ...
  return (
    <>
      ...
      <section className="text-center pt-12 pb-2">
        <div className="max-w-[1100px] mx-auto px-6">
          <Image
            ...
            height={240}
            priority
            className="mx-auto w-[min(320px,70vw)] h-auto drop-shadow-[0_0_60px_rgba(0,229,255,0.2)] animate-[fadeUp_1.2s_cubic-bezier(0.16,1,0.3,1)_both]"
          />
          <h1 className="font-body text-[clamp(1.8rem,5vw,2.8rem)] font-bold leading-tight mt-1.5 mb-7 max-w-[550px] mx-auto animate-[fadeUp_1s_cubic-bezier(0.16,1,0.3,1)_0.2s_both]">
      ...
      <section className="max-w-[1100px] mx-auto px-6 mb-16">
        <GlassCard className="max-w-[820px] mx-auto p-7 text-center animate-[fadeUp_1s_cubic-bezier(0.16,1,0.3,1)_0.5s_both]">
